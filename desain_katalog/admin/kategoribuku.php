                ...
                <tr>
                  ...
                  <td align="center">
                    ...
                    <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_buku; ?>?'))window.location.href =  
                      'kategoribuku.php?aksi=hapus&data=<?php echo $id_kategori_buku; ?>&notif=hapusberhasil'" " class=" btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
                  </td>
                </tr>
              <?php $no++;
              } ?>
        ...
        <div class="card-footer clearfix">
          <ul class="pagination pagination-sm m-0 float-right">
            ...
            if ($jum_halaman == 0) {
              ...
              if (isset($_GET["katakunci"])) {
                $katakunci_kategoribuku = $_GET["katakunci"];
                if ($halaman != 1) {
                  echo "<li class='page-item'><a class='page-link' href='kategoribuku.php?katakunci=$katakunci_kategoribuku&halaman=1'>First</a></li>";
                  echo "<li class='page-item'><a class='page-link' href='kategoribuku.php?katakunci=$katakunci_kategoribuku&halaman=$sebelum'>«</a></li>";
                }
                for ($i = 1; $i <= $jum_halaman; $i++) {
                  if ($i > $halaman - 5 and $i < $halaman + 5) {
                    if ($i != $halaman) {
                      echo "<li class='page-item'><a class='page-link'href='kategoribuku.php?katakunci=$katakunci_kategoribuku&halaman=$i'>$i</a></li>";
                    } else {
                ...
                if ($halaman != $jum_halaman) {
                  echo "<li class='page-item'><a class='page-link'href='kategoribuku.php?katakunci=$katakunci_kategoribuku&halaman=$setelah'>»</a></li>";
